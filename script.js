...
header.style.background = "#BE73FA";
header.style.height = "10%";
header.style.width = "50%";
header.style.padding = "10%  3%";
header.style.border = "2px solid #E1FFF7";
...
h1.textContent = "Calcule seu IMC";
...
iconReset.src = "./reset.png";
iconReset.style.width = "58px";
iconReset.style.height = "58px";
iconReset.style.position = "absolute";
iconReset.style.right = "28%";
iconReset.style.top = "19.5%";
iconReset.style.transition = ".5s";
iconReset.addEventListener("click", function () {
  iconReset.style.transform = "scale(1.5) rotate(390deg)"
  setTimeout(() => {
...
inputName.style.width = "514px";
inputName.style.height = "35px"
inputName.style.margin = "2px";
...
inputPeso.style.width = "116px";
inputPeso.style.height = "35px"
inputPeso.style.margin = "2px";
inputPeso.style.padding = "1px";
...
containerInput.appendChild(inputPeso);
...
calcule.style.backgroundColor = "#A52A2A";
calcule.style.borderRadius = "10%";


calcule.addEventListener("mouseenter", function (){
  calcule.style.backgroundColor = "	rgb(178,34,34)";
  calcule.style.transform = "scale(1.05)";
});
calcule.addEventListener("mouseleave", function (){
  calcule.style.backgroundColor = "#A52A2A";
  calcule.style.transform = "scale(1)";
});
